...
export default class BaseShape {
  ...
  createMesh() {
    const geometry = this.params.geometry || new THREE.CylinderGeometry(
      this.params.cubeSize / 2, // radiusTop
      this.params.cubeSize / 2, // radiusBottom 
      this.params.cubeSize,     // height
      32,                       // radialSegments (increases smoothness)
      1                         // heightSegments
    );
